-- =====================================================
-- 013_account_adjustments.sql
-- Kategori buat adjustment + update seed function
...
-- =====================================================
-- 2. INSERT KATEGORI BARU UNTUK USER EXISTING
-- =====================================================
INSERT INTO public.categories (user_id, name, type, group_name, icon, color, sort_order)
SELECT 
  u.id AS user_id,
...
WHERE NOT EXISTS (
  ...
  WHERE c.user_id = u.id AND c.name = 'Penyesuaian Saldo'
);