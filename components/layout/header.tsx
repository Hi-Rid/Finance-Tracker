      ...
      <div className="flex items-center justify-between h-16 px-4 md:px-6">
        ...
        <div className="flex items-center gap-3 min-w-0">
          <div className="md:hidden flex items-center gap-2 shrink-0">
            <div className="w-8 h-8 rounded-xl bg-brand flex items-center justify-center text-brand-foreground font-bold text-sm shadow-md shadow-brand/30">
              F
            </div>
          </div>
        ...
        <div className="hidden md:flex items-center flex-1 max-w-sm mx-6">
          <button className="group flex items-center gap-2 w-full h-9 px-3 rounded-xl border border-border/60 bg-card/50 hover:bg-card transition-all text-sm text-muted-foreground hover:border-primary-400/40">
