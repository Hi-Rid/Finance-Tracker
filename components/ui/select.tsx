    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "dark:bg-[#0A1A40] dark:text-white dark:border-white/15",
          className
        )}
        position={position}
        {...props}
...
function SelectLabel({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Label>) {
  return <SelectPrimitive.Label data-slot="select-label" className={cn("px-2 py-1.5 text-xs text-slate-500 dark:text-slate-400", className)} {...props} />
}
...
function SelectSeparator({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Separator>) {
  return <SelectPrimitive.Separator data-slot="select-separator" className={cn("-mx-1 my-1 h-px bg-slate-200 dark:bg-white/10", className)} {...props} />
}
